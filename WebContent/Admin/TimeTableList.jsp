...
if(request.getParameter("eid")!=null){
	  db.executeSql("delete from timetable where SrNo=?", request.getParameter("eid"));
	}
%>

<div class="mt-2 mb-2 d-flex flex-row-reverse">
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/timetable.jsp">Back</a>
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/AddTimeTable.jsp">Add Time Table</a>
</div>
<div class="col-10 offset-1">
    ...
    <table id="table1" class="table table-bordered">
        ...
        <tbody>
        <%
        ResultSet rs = db.getRows("SELECT * FROM timetable");
        while(rs.next()){
        %>
        <tr>
