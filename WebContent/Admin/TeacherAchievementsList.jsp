...
if(request.getParameter("eid")!=null){
	  db.executeSql("delete from teachersachievements where SrNo=?", request.getParameter("eid"));
	}
%>

<div class="mt-2 mb-2 d-flex flex-row-reverse">
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/AddTeacherAchievements.jsp">Add Teacher Achievements</a>
</div>
<div class="col-10 offset-1">
    <br/>
    <h1>Teacher Achievements List:</h1>
