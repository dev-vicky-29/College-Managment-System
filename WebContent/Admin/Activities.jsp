...
<br><hr>
<div class="container">
    <h3 class="text-center">View Activities</h3>
    <div class="text-center">
        <a type="button" class="btn btn-primary btn-lg" href="/College_Managment_System/Admin/AddActivities.jsp">Add New Activity</a>
    </div>
</div>
<hr>
