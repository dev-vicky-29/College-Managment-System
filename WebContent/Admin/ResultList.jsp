...
if(request.getParameter("eid")!=null){
	  db.executeSql("delete from result where SrNo=?", request.getParameter("eid"));
	}
%>

<div class="mt-2 mb-2 d-flex flex-row-reverse">
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/results.jsp">Back</a>
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/AddResult.jsp">Add Result</a>
</div>
