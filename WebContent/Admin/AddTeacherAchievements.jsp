...
<!-- Teacher Achievements Related Files -->
  ...
  //Sr.No	Name	Date	Type	Title	Description	Report
 	...
 	upBean.setFolderstore(path); //Store Uploaded Files In This Folder.
 		...
 		if(MultipartFormDataRequest.isMultipartFormData(request)){
			...
			db.executeSql("insert into teachersachievements (SrNo, Name, Date, Type, Title, Description, Report)  values (?,?,?,?,?,?,?)", SrNo, Name,Date, Type, Title, Description, fileImgName); //This Line For Insert Record Into Database nonteachingfaculty table	
...
%>
  ...
  <!-- Add Teacher Achievements Reports -->
  
  <div class="mt-2 mb-2  d-flex flex-row-reverse">
    <a class="btn btn-primary pr-5" href="/College_Managment_System/Admin/TeacherAchievementsList.jsp">Teacher Achievements List</a>
</div>
	<div class="card mt-5 col-7 offset-2">
	<div class="card-header bg-info text-white">
	<h4 class="text-center">Add Teacher Achievements Reports</h4>
	</div>
	<div class="card-body">
	<!-- HTML FORM -->
